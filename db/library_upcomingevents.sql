...
CREATE TABLE `upcomingevents` (
  ...
  `eventDetail` varchar(250) NOT NULL,
...
INSERT INTO `upcomingevents` VALUES (1,'? Exciting News: J.K. Rowling will launch their eagerly awaited book on 17.02.2024 at Vega City promising a literary masterpiece that has fans on the edge of their seats! ?✨ #BookRelease #LiteraryEvent','2024-02-17');
